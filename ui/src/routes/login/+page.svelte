<div
  class="w-full h-dvh bg-neutral-50 dark:bg-neutral-900 dark:text-neutral-50 flex flex-col items-center justify-center"
>
  ...
  <div class="flex mt-8 text-xs text-neutral-700">
